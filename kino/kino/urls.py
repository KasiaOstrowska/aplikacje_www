...
urlpatterns = [
    ...
    path('', views.KinoList.as_view()),
    path('/<int:pk>', views.KinoDetail.as_view()),
    path('film/', views.FilmList.as_view()),
    path('film/<int:pk>', views.FilmDetail.as_view()),
    path('seans/', views.SeansList.as_view()),
    path('seans/<int:pk>', views.SeansDetail.as_view()),
    ...
    path('uzytkownik/<int:pk>', views.UzytkownikDetail.as_view()),
